...
#!/bin/bash
#This is a generic interface script for coupling Elmer with Dakota
...
#Transfer new parameters from Dakota parameters file to Elmer simulation input file (Elmer_file)
dprepro $params sim.template Elmer_file

#Transfer the Elmer simulation input file, with new parameters, from Dakota workspace to Elmer workspace
